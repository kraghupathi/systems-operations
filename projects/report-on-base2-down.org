...
**** Install ldap related packages
     ...
     yum -y install mod_fcgid.x86_64
     yum install -y mod_fcgid.x86_64 fcgi.x86_64 mod_proxy_fcgi.x86_64
     yum -y install httpd mod_fastcgi
     service slapd start
     service nslcd start
     vim /etc/httpd/conf/httpd.conf  ---comment 221 line and save the file
...
**** Enable User directories over httpd for choppell user
     This way we can enable user directories over http
     #+BEGIN_EXAMPLE
     chmod 711 /home/choppell/
     chown choppell:choppell /home/choppell/public_html
     chmod 755 /home/choppell/public_html
     setsebool -P httpd_enable_homedirs true
     chcon -R -t httpd_sys_content_t /home/choppell/public_html
     chmod 644 /home/choppell/public_html/index.html
     #+END_EXAMPLE
     
     - NOTE :: The above steps applicable to all other users as well.
